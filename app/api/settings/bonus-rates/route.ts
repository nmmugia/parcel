...
export async function POST(request: NextRequest) {
  try {
    ...
    console.error("Error saving bonus rates:", error)
    return NextResponse.json({ error: "Terjadi kesalahan saat menyimpan pengaturan bonus" }, { status: 500 })
  }
}
...
export async function GET() {
  try {
    ...
    return NextResponse.json({ error: "Terjadi kesalahan saat mengambil pengaturan bonus" }, { status: 500 })
  }
}
