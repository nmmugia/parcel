          ...
          <CardContent className="pb-3">
            <div className="aspect-video relative rounded-md overflow-hidden mb-4">
              {packageItem.imageUrl ? (
                <Image
                  src={packageItem.imageUrl || "/placeholder.svg"}
            ...
            <div className="space-y-2">
              <div className="flex justify-between">
                ...
                <span className="font-medium">{formatCurrency(packageItem.price)}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-muted-foreground">Tenor:</span>
                <span className="font-medium">{packageItem.tenorMonths} bulan</span>
              </div>
              <div className="flex justify-between">
                <span className="text-muted-foreground">Cicilan per Bulan:</span>
                <span className="font-medium">{formatCurrency(packageItem.monthlyAmount)}</span>
              </div>
              <div className="flex justify-between">
