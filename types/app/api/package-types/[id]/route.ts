...
export async function PUT(request: NextRequest, { params }: { params: { id: string } }) {
  try {
    ...
    return NextResponse.json({ error: "Terjadi kesalahan saat memperbarui jenis paket", details: error }, { status: 500 })
  }
}
...
export async function DELETE(request: NextRequest, { params }: { params: { id: string } }) {
  try {
    ...
    return NextResponse.json({ error: "Terjadi kesalahan saat menghapus jenis paket", details: error }, { status: 500 })
  }
}
