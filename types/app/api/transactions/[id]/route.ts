...
export async function GET(request: NextRequest, { params }: { params: { id: string } }) {
  try {
    ...
    return NextResponse.json({ error: "Terjadi kesalahan saat mengambil transaksi", details: error }, { status: 500 })
  }
}
...
export async function PATCH(request: NextRequest, { params }: { params: { id: string } }) {
  try {
    ...
    return NextResponse.json({ error: "Terjadi kesalahan saat memperbarui transaksi", details: error }, { status: 500 })
  }
}
