    ...
    try {
      const response = await fetch("/api/transactions", {
        ...
        body: JSON.stringify({
          ...
          resellerId,
          tenorWeeks: packageData.tenorWeeks,
          weeklyAmount: packageData.weeklyAmount,
        }),
      })
      ...
      <CardContent>
        <div className="mb-6 p-4 bg-muted rounded-md">
          ...
          <div className="grid grid-cols-2 gap-2 text-sm">
            ...
            <div>Jumlah Minggu:</div>
            <div className="font-medium">{packageData.tenorWeeks} Minggu</div>
            <div>Pembayaran per Minggu:</div>
            <div className="font-medium">{formatCurrency(packageData.weeklyAmount)}</div>
          </div>
        </div>
