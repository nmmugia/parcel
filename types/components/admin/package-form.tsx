...
const packageSchema = z.object({
  ...
  tenorWeeks: z.coerce.number().int().positive("jumlah minggu harus lebih dari 0"),
  weeklyAmount: z.coerce.number().positive("pembayaran mingguan harus lebih dari 0"),
...
export function PackageForm({ packageTypes, packageData }: PackageFormProps) {
  ...
  const form = useForm<PackageFormValues>({
    ...
    defaultValues: {
      ...
      tenorWeeks: packageData?.tenorWeeks || 48,
      weeklyAmount: packageData?.weeklyAmount || 0,
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div className="grid gap-6 md:grid-cols-2">
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>Jumlah Minggu</FormLabel>
                    <FormControl>
                      <Input
                        type="number"
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>Pembayaran per Minggu (Rp)</FormLabel>
                  <FormControl>
                    <Input type="number" placeholder="Masukkan pembayaran per minggu" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
